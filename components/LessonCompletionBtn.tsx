...
import { incompleteLessonAction } from "@/app/actions/incompleteLessonAction";
...
export function LessonCompleteBtn({
    lessonId,
    clerkId,
    ...
    const handleToggle = async () => {
        ...
        setIsPending(true);
        if (isCompleted) {
            await incompleteLessonAction(lessonId, clerkId);
        } else {
            ...
            <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
                ...
                >
                    {isLoading ? (
                        ...
                        <>
                            <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                            {isCompleted ? "Incompleted" : "Completing..."}
                        </>
                    ) : isCompleted ? (
                        <>
